...
Map<String, Map<String, Map<String, Map<String, Map<String, String>>>>>
  ...
  'Civil Engineering': {
    ...
    'Electives': {
      ...
      'Basics of Soil Dynamics & Earthquake Engg': {
        'cie1': {
          '2017': '',
        }
      },
    ...
    'Open Elective': {
      ...
      'Process Economies & Plant Design': {
        'cie1': {
          '2017': '',
        }
      },
  ...
  'BioTechnology': {
    ...
    '3 - Semester': {
      ...
      'Cytogenetics & Cell Culture Techniques': {
        'cie1': {
          '2017': '',
        }
      },
    ...
    '5 - Semester': {
      ...
      'Bioprocess and Reaction Engineering': {
        'cie1': {
          '2017': '',
        }
      },
    ...
    '6 - Semester': {
      'Enzyme Kinetics and Biotransformation': {
        'cie1': {
          '2017': '',
        }
      },
  ...
  'Electronics and Electrical': {
    ...
    'Electives': {
      'Fundamentals of Solar Thermal ECS': {
        'cie1': {
          '2017': '',
        }
      },
      ...
      'Electrical Power Utilization and Drives': {
        'cie1': {
          '2017': '',
        }
      },
      'Fundamentals of Wind Energy Conversion Systems': {
        'cie1': {
          '2017': '',
        }
      },
      ...
      'Standards and Indian Electricity Act': {
        'cie1': {
          '2017': '',
        }
      },
      'Autotronics (Automotive Electronics)': {
        'cie1': {
          '2017': '',
        }
      },
      ...
      'Energy Conservation, Audit and DSM': {
        'cie1': {
          '2017': '',
        }
      },
  ...
  'Industrial Production': {
    ...
    '5 - Semester': {
      ...
      'Theory of Metal Cutting & Tool Design': {
        'cie1': {
          '2017': '',
        }
      },
...
//Information Science Engineering
  'Information Science': {
    ...
    '8 - Semester': {
      'Management & Entrepreneurship (HSS)': {
        'cie1': {
          '2017': '',
        }
      },
  ...
  'Automobile Engineering': {
    ...
    'Electives': {
      'Non Traditional Marching Process': {
        'cie1': {
          '2017': '',
        }
      },
      'Rocket and Jet Propulsive Systems': {
        'cie1': {
          '2017': '',
        }
      },
      'On and Off Board Vehicle Diagnostics': {
        'cie1': {
          '2017': '',
        }
      },
      ...
      'Intelligent Transport Systems and Future trends': {
        'cie1': {
          '2017': '',
        }
      },
      ...
      'Engine Trouble Diagnosis and Rebuilding ': {
        'cie1': {
          '2017': '',
        }
      },
